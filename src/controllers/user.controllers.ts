...
export const retrieveUserProfileController = async (request: Request, response: Response) => {
...
export const getUploadImageController = async (request: Request, response: Response) => {
...
export const uploadImageUserController = async (request: Request, response: Response) => {
  const upload = await cloudinary.uploader.upload(request.file!.path, async (error, result) => {
    const upload = await updateImageUserService(result.secure_url, request.params.id);
...
export const deleteUserAccountController = async (request: Request, response: Response) => {
